...
[![CI](https://github.com/davebarnwell/rollbar-cli/actions/workflows/pr-tests.yml/badge.svg?event=pull_request)](https://github.com/davebarnwell/rollbar-cli/actions/workflows/pr-tests.yml)
